...
class Livres extends Component {
    ...
    state = {
        livres : [
            {id:1, titre:"L'algorithmique selon moi", auteur:"c0ca", nbPages: 200},
            {id:2, titre:"La France du 19ème", auteur:"Albert PATIRCK", nbPages: 500},
    ...
    render() {
        return (
            <>
                ...
                {this.props.ajoutLivre ? <FormulaireAjout validation = {this.handleAjoutLivre}/> : null}
            </>
        );
    }
}
